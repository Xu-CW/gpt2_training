...
class Hyperparameters:
    ...
    num_iterations : int = 2980  # number of iterations to run
    warmup_iters : int = 0
    cooldown_iters : int = 1200  # number of iterations of linear warmup/cooldown for triangular or trapezoidal schedule
